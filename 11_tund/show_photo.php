<?php
	...
	$conn = new mysqli($server_host, $server_user_name, $server_password, $database);$stmt = $conn->prepare("SELECT filename, userid, privacy FROM vp_photos WHERE id = ? AND deleted IS NULL");
